...
GLvoid drawScene(GLvoid){
	...
	gluLookAt(0.0, fLXNum, 0.0, 0.0, 0.0, -100.0, 0.0, 1.0, 0.0);
	gluLookAt(fLYNum, 0.0, 0.0, 0.0, 0.0, -100.0, 0.0, 1.0, 0.0);
	gluLookAt(0.0, 0.0, fLZNum, 0.0, 0.0, -100.0, 0.0, 1.0, 0.0);
